...
If any of this resonates with you and you might want to build it, I would love to [hear from you]({{ '/contact.html' | relative_url }}). 
...
Many groups need reading lists, discussion questions, facilitator notes, and maybe short guide videos—not only for university intro groups (technical, policy, strategy tracks) but also for the start of research fellowships and other onboarding. Ideally this would be modular: different topic bundles, reading levels, and lengths (e.g. four weeks vs. a full semester), so organizers can mix and match instead of rebuilding from scratch each time. I touched on some of my own experience running intro programs in [an earlier post]({{ '/posts/guide-to-intro-ais-reading-group/' | relative_url }}); the natural next step for the ecosystem is shared, versioned curricula that many groups can adopt and improve.

### Research on AIS-related survey and application questions
